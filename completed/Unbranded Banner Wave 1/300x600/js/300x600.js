window.onload = function() {
  ...
  TweenLite.to(container, 3, {x: 2, y: 112, ease: Power0.easeNone, delay: 2}, 0);
  TweenLite.to(container, 1, {scale: .51, ease: Power0.easeNone, delay: 2}, 0);
  ...
  TweenLite.to([bgCanvas, maskCanvas], 3, {y: 27, scale: 1.05, ease: Power2.easeOut, delay: 6.6}, 0);
  TweenLite.to(container, 3, {x: 0, y: 138, scale: .4425, ease: Power2.easeOut, delay: 6.6}, 0);
