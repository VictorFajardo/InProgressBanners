window.onload = function() {
  ...
  TweenLite.set(woman, {opacity: 0, x: -10, y:0, ease: Power2.easeIn, delay: 0}, 0);
  ...
  TweenLite.to(text11, .75, {opacity: 1, x:0, ease: Power2.easeOut, delay: 0}, 0);
  ...
  TweenLite.to(one, 1,   {opacity: 1, ease: Power2.easeInOut, delay: 7}, 0);
  TweenLite.to(woman, 1, {opacity: 1, scale: .72, x: -143, y: 6, ease: Power2.easeInOut, delay: 7}, 0);
  TweenLite.to(logoblock, 1, { y: -47, ease: Power2.easeInOut, delay: 7}, 0);
  TweenLite.to(scroll, 1, { x: -161, ease: Power2.easeInOut, delay: 7}, 0);

  TweenLite.to(scrollwrapper, 7, {scrollTop: 48, ease: Power0.easeNone, delay: 7+1}, 0);
}//end
