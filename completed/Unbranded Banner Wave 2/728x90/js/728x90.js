window.onload = function() {
  ...
  TweenLite.to(container, 3, { x: -244, y: -22, ease: Power2.easeOut, delay: 2 }, 0);
  TweenLite.to(container, 1, { scale: .52, ease: Power0.easeNone, delay: 2 }, 0);
  TweenLite.to(text1, 1, { opacity: 1, x: 0, ease: Power2.easeOut, delay: 4.4 }, 0);
  TweenLite.to([bgCanvas, maskCanvas], 5.5, { x: -68, y: -24, scale: .32, ease: Power2.easeOut, delay: 5.5 }, 0);
  TweenLite.to(container, 5.5, { x: -312, y: -46, scale: .1767, ease: Power2.easeOut, delay: 5.5 }, 0);
