window.onload = function() {
  ...
  nodes.forEach(function (el, i, arr) {
    if (i < introText.length) {
      TweenLite.set(el, { x: -95, y: -129, opacity: 0, scale: 1.86, delay: 0 }, 0);
  ...
  TweenLite.to([bgCanvas, maskCanvas], 5.5, { x: -5, y: 27, scale: 1.0774, transformOrigin: "50% 50%", force3D: true, rotationZ: "0.1deg", translateZ: -100, ease: Power2.easeOut, delay: 8 }, 0);
  TweenLite.to(container, 5.5, { x: -5, y: 27, scale: .595, transformOrigin: "50% 50%", force3D: true, rotationZ: "0.1deg", translateZ: -100, ease: Power2.easeOut, delay: 8 }, 0);
