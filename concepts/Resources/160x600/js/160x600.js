window.onload = function() {
  ...
  nodes.forEach(function (el, i, arr) {
    if (i < introText.length) {
      TweenLite.set(el, { x: -84, y: -344, opacity: 0, scale: 1.62, delay: 0 }, 0);
      ...
      TweenLite.set(el, { x: randomValue() - el.dataset.inix, y: 3 * randomValue() - el.dataset.iniy, opacity: 0, scale: Math.random() * 3 + 3, delay: 0 }, 0);
    }
  ...
  // TweenLite.to([bgCanvas, maskCanvas], 5.5, { x: -5, y: 27, scale: 1.0774, ease: Power2.easeOut, delay: 8 }, 0);
  // TweenLite.to(container, 5.5, { x: -5, y: 27, scale: .595, ease: Power2.easeOut, delay: 8 }, 0);
