window.onload = function() {
  ...
  TweenLite.to([bg1, img1, img2, pylon], 1.5, {x: -67, ease: Power2.easeOut, delay: 3.5}, 0);
  ...
  TweenLite.to(uc, .25, {y: 11, ease: Power2.easeOut, delay: 8.5}, 0);
  ...
  TweenLite.to([white, text3], .25, {x: -356, ease: Power2.easeOut, delay: 8.5}, 0);
