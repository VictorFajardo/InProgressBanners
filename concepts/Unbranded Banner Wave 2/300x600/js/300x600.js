window.onload = function() {
  ...
  TweenLite.to(container, 3, {x: -11, y: 45.5, ease: Power0.easeNone, delay: 2}, 0);
  TweenLite.to(container, 1, {scale: .69, ease: Power0.easeNone, delay: 2}, 0);
  TweenLite.to(text1, 1, { opacity: 1, x: 0, ease: Power2.easeOut, delay: 4.4 }, 0);
  TweenLite.to([bgCanvas, maskCanvas], 3, {x: 1, y: 33, scale: 1.05, ease: Power2.easeOut, delay: 5.5}, 0);
  TweenLite.to(container, 3, {x: -10, y: 79, scale: .58, ease: Power2.easeOut, delay: 5.5}, 0);
